...
Smooth = function(arr, config) {
  var baseDomainEnd, dimension, i, interpolator, interpolatorClass, interpolators, k, n, properties, smoothFunc, v, _ref, _ref1, _ref2;
  if (config == null) {
    config = {};
  }
  properties = {};
  ...
  if ((_ref = config.scaleTo) == null) {
    config.scaleTo = config.period;
  }
  if ((_ref1 = config.sincFilterSize) == null) {
